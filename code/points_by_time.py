...
if __name__ == "__main__":
    ...
    if(len(sys.argv[1:]) == 1):
        ...
        illumination_file_names = ['moon_rel_positions_44_25', 'moon_rel_positions_28_25', 'moon_rel_positions_-86_43.mat', 'moon_rel_positions_-34_25']
        ...
        clockwise = 1 if choice_illumination>2 else 0
